...
"MSWin32-x86-multi-thread-64int-10.0.17134.471" or
	die "Errno architecture (MSWin32-x86-multi-thread-64int-10.0.17134.471) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
...
our %EXPORT_TAGS = (
    ...
    WINSOCK => [qw(
	WSAENOPROTOOPT WSAECONNRESET WSAETIMEDOUT WSAENETRESET WSAENETDOWN
	WSAESHUTDOWN WSAENETUNREACH WSAEPROTOTYPE WSAEINTR WSAEALREADY
	WSAEMFILE WSAENOBUFS WSAEBADF WSAEACCES WSAEREMOTE WSAEMSGSIZE
	WSAEADDRNOTAVAIL WSAECANCELLED WSAECONNABORTED WSAEINPROGRESS
	WSAEAFNOSUPPORT WSAEADDRINUSE WSAESOCKTNOSUPPORT WSAEDESTADDRREQ
	WSAELOOP WSAEINVAL WSAESTALE WSAENOTEMPTY WSAEOPNOTSUPP WSAENOTSOCK
	WSAECONNREFUSED WSAENOMORE WSAETOOMANYREFS WSAEFAULT WSAEDQUOT
	WSAEUSERS WSAEPROCLIM WSAENAMETOOLONG WSAEREFUSED WSAEISCONN
	WSAEPFNOSUPPORT WSAEPROVIDERFAILEDINIT WSAEHOSTUNREACH
	WSAEPROTONOSUPPORT WSAEDISCON WSAEWOULDBLOCK WSAEINVALIDPROCTABLE
	WSAENOTCONN WSAEINVALIDPROVIDER WSAEHOSTDOWN
    )],
);
